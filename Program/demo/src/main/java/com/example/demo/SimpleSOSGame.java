...
public class SimpleSOSGame extends SOSGame {
    ...
    public void gameRules(Board board, Board SOSBoard, PlayerBox blue, PlayerBox red,
                          GUI guiInput, Box boxInput, Label turnInput, Board recordGameBoard,
                          ArrayList<String> recordGameMoves) {
        ...
        this.setRecordGameBoard(recordGameBoard);
        this.setRecordGameMoves(recordGameMoves);
