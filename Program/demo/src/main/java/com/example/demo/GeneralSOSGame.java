...
public class GeneralSOSGame extends SOSGame {
    ...
    public void gameRules(Board board, Board SOSBoard, PlayerBox blue, PlayerBox red,
                          GUI guiInput, Box boxInput, Label turnInput, Board recordBoard,
                          ArrayList<String> recordMoves) {
        ...
        this.setRecordGameBoard(recordBoard);
        this.setRecordGameMoves(recordMoves);
        ...
        letterDrawn = this.drawALetter(this.getBoard(), this.getSOSBoard(), this.getBluePlayer(),
                ...
                this.getRecordGameBoard(), this.getRecordGameMoves());
        ...
        if (this.getBoard().getGameOver()) {
            ...
            if(this.getBoard().getRecordGame()) {
                Path output = Paths.get("output.txt");
                try {
                    Files.write(output, this.getRecordGameMoves());
                } catch (Exception e) {
                    e.printStackTrace();
                }
        ...
        //game rules (since we don't need to wait on a human's input).
            ...
            gameRules(this.getBoard(), this.getSOSBoard(), this.getBluePlayer(), this.getRedPlayer(),
                    this.getGui(), this.getBox(), this.getDisplayTurn(), this.getRecordGameBoard(),
                    this.getRecordGameMoves());
        }
